...
CREATE TABLE `cache` (
  ...
  `value` mediumtext COLLATE NOT NULL,
...
CREATE TABLE `jobs` (
  `id` bigint UNSIGNED NOT NULL,
  `queue` varchar(255) COLLATE NOT NULL,
  `payload` longtext COLLATE NOT NULL,
...
CREATE TABLE `job_batches` (
  `id` varchar(255) COLLATE NOT NULL,
  `name` varchar(255) COLLATE NOT NULL,
  `total_jobs` int NOT NULL,
  `pending_jobs` int NOT NULL,
  `failed_jobs` int NOT NULL,
  `failed_job_ids` longtext COLLATE NOT NULL,
  `options` mediumtext COLLATE,
...
CREATE TABLE `sessions` (
  `id` varchar(255) COLLATE NOT NULL,
  `user_id` bigint UNSIGNED DEFAULT NULL,
  `ip_address` varchar(45) COLLATE DEFAULT NULL,
...
CREATE TABLE `users` (
  `id` bigint UNSIGNED NOT NULL,
  `nama_depan` varchar(50) CHARACTER SET utf8mb4 COLLATE NOT NULL,
  `nama_belakang` varchar(50) COLLATE NOT NULL,
  `phone` varchar(15) CHARACTER SET utf8mb4 COLLATE DEFAULT NULL,
  `email` varchar(255) COLLATE NOT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `password` varchar(255) COLLATE NOT NULL,
  `role` enum('Admin','Cashier','User','') CHARACTER SET utf8mb4 COLLATE NOT NULL DEFAULT 'User',
