            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                var completeOrderOptions = {
                                    ...
                                    title: {
                                        text: 'Perbandingan Order Status'
                                    },
                                    noData: {
                                        text: 'Tidak ada data tersedia'
                                    }
                        ...
                        <div class="row">
                            <!-- Card untuk Jumlah Anggota Aktif -->
 
                            <!-- Card Payments -->
                            <div class="col-6 mb-6 mt-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                            <div class="avatar flex-shrink-0">
                                                <img src="owner/dashboard/assets/img/icons/unicons/paypal.png"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-6 mb-6">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <!-- Card untuk Jumlah User Aktif -->
                                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                            <div class="avatar flex-shrink-0">
                                                <i class="fa-solid fa-users fs-4 p-2 bg-success"
                                                    style="color: white; border-radius: 5px;"></i>
                                            </div>
                                            <div class="dropdown">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body pt-4">
                                        <ul class="p-0 m-0">
                                            ...
                                            <li class="d-flex align-items-center mb-6">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="owner/dashboard/assets/img/icons/unicons/chart.png"
                                                        alt="User" class="rounded" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="owner/dashboard/assets/img/icons/unicons/cc-warning.png"
                                                        alt="User" class="rounded" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
