            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <h3 class="card-header element-title text-uppercase pb-2" style="font-family: 'Montserrat', sans-serif; font-weight: 400; color: #63374d;">Members List</h3>
                                ...
                                <table id="example1" class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center; font-weight: 700;">Point</th>
                                            <th style="text-align:center; font-weight: 700;">Join Date</th>
