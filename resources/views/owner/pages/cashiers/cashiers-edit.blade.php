...
<head>
    ...
    <title>Ave Beauty Salon - Edit Cashier</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <h3 class="card-header element-title text-uppercase pb-2" style="font-family: 'Montserrat', sans-serif; font-weight: 400; color: #63374d;"">Edit Cashier</h4>
                            <div class="card-body">
                                <form action="{{ route('cashiers.update', $cashier->cashier_id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="is_active" name="is_active" required>
                                            <option value="1" {{ $cashier->is_active ? 'selected' : '' }}>Active
                                            </option>
                                            <option value="0" {{ !$cashier->is_active ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
