      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="form-check ps-4">
            ...
            <label class="form-check-label px-0" for="same-address">Shipping address is the same as my billing address</label>
          </div>

          <div class="form-check ps-4">
            <input type="checkbox" class="form-check-input" id="save-info">
            <label class="form-check-label px-0" for="save-info">Save this information for next time</label>
          </div>
