    ...
    @else
        ...
        <form wire:submit.prevent="submitSearch">
            <div class="input-group mb-3 mt-5">
                <input type="text" wire:model="search" class="form-control border-0 border-bottom"
                    placeholder="Search by Invoice Code or Product Name..." style="padding-right: 50px!important;background-color: transparent!important;">
                <button class="search-submit border-0 position-absolute bg-transparent" type="submit" style=" right: 15px;"><a href=""><svg class="search" width="24" height="24">
